    ...
    <section class="hero">
      <div class="hero-grid">
        <div class="hero-content">
          <h1>Klinik Umum & <span class="highlight">Gigi</span></h1>
          <h1>Tirta <span class="highlight">Amerta</span></h1>
          <p>
            Nikmati layanan kesehatan umum dan perawatan gigi yang profesional,
            cepat, dan nyaman bersama tenaga medis kami.
          </p>
          <div class="hero-actions">
            <a href="https://wa.me/yournumber" class="btn-primary"
              >Mulai Perjalanan Kesehatan</a
            >
          </div>
        </div>
      </div>
      <div class="hero-image">
        <div class="circle-bg">
          <img src="dr.dony.png" alt="Medical Professional" class="hero-img" />
        </div>
        <div class="badge badge-1">
          <i class="fas fa-user-md"></i>
          <div class="badge-text">
            <span class="name">drg. Doni Marita Istata, M.Kes</span>
            <span class="title">Founder Klinik Pratama Tirta Amerta</span>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="about-section">
      <div class="about-row">
        <div class="about-text">
          ...
          <h2>
            Didukung oleh <br /><span class="highlight"
              >Tim Dokter Terbaik</span
            >
          </h2>
          <p>
      ...
      <div class="about-row">
        <div class="about-text">
          ...
          <h2>
            Dipercaya Masyarakat <br /><span class="highlight"
              >Sejak Tahun 2011</span
            >
          </h2>
          <p>
        ...
        <div class="facility-grid" id="facilityGrid">
          <div class="facility-card">
            <a href="../layanan/Layanan.html">
              ...
              <img
                src="../Fasilitas/IMG_20260126_163138.jpg.jpeg"
                alt="Ruang Dokter Umum"
              />
            </div>
            <div class="facility-info"><h3>Ruang Dokter Umum</h3></div>
            </a>
          </div>
          ...
          <div class="facility-card">
            ...
            <div class="facility-info"><h3>Ruangan Gigi Modern</h3></div>
          </div>

          <div class="facility-card">
            <div class="facility-img">
              <img
                src="../Fasilitas/IMG_20260126_163332.jpg.jpeg"
                alt="Tunggu"
              />
            </div>
            <div class="facility-info"><h3>Ruang Tunggu Nyaman</h3></div>
          </div>
          ...
          <div class="facility-card">
            ...
            <div class="facility-info"><h3>Amerta Cafe</h3></div>
          </div>
        </div>
      </div>
    ...
    <section class="consult-cta">
      <div class="consult-wrapper">
        <div class="consult-content">
          ...
          <h2>
            Siap Untuk Berkonsultasi <br /><span class="highlight"
              >Mengenai Kesehatan Anda?</span
            >
          </h2>
        </div>

        <div class="consult-action">
          <a href="https://wa.me/nomor-wa-klinik" class="btn-consult">
            <div class="btn-flex">
          ...
          <div class="contact-details">
            <div class="contact-item">
              ...
              <div class="text-group">
                ...
                <p>
                  Jl. Adirasa No. 15, Kolor, Kecamatan Kota Sumenep, Kabupaten
